 ...
 */
class UpdateConstructorTest extends PHPUnit_Framework_TestCase
{
    use Phpunit_Util;
//******************************************************************************
    ...
    protected function setUp()
    {
        ...
        $this->comando_mock = $this->helper->getComandoDmlMock($conexion, $clausula_fabrica, $fabrica_condiciones, ['update']);
...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: limit ">
    ...
    /**
     * @covers GT\Libs\Sistema\BD\QueryConstructor\Sql\Comando\Comando\Constructor\Sql::limit
     * @group limit
     */
