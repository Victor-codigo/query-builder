 ...
 */
class UpdateCadenaTest extends PHPUnit_Framework_TestCase
{
    use Phpunit_Util;
//******************************************************************************
...
//******************************************************************************
     ...
     * @group increment
     */
    public function testIncrement__incremento_menor_que_0()
    {
        $atributo = 'atributo';
        $incremento = -1;
...
//******************************************************************************
     ...
     * @group decrement
     */
    public function testDecrement__decremento_menor_que_0()
    {
        $atributo = 'atributo';
        $incremento = -1;
