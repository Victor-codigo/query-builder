...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: generar ">
     ...
     * @group generar
     */
    public function testGenerar__Sin_joins_una_tabla()
    {
        $expects = 'FROM tabla1';
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar__Sin_joins_varias_tablas()
    {
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar__Con_un_join_una_tabla()
    {
        $expects = 'FROM tabla1' .
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar__Con_un_varios_join_una_tabla()
    {
        $expects = 'FROM tabla1' .
                    ' LEFT JOIN tabla2 ON tabla1.atributo = tabla2.atributo' .
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar__Con_un_varios_join_varias_tablas()
    {
