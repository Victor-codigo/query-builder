 ...
 */
class GrupoOperadoresTest extends PHPUnit_Framework_TestCase
{
    use Phpunit_Util;
//******************************************************************************
...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: getOperadores ">
    ...
    public function testGetOperadores()
    {
        ...
        $this->assertEquals(array($and_operador), $resultado,
            'ERROR: el valor devuelto no es el esperado');
    }
//******************************************************************************
...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: operadorAdd ">
    ...
    public function testOperadorAdd()
    {
        ...
        $this->assertEquals(array($and_operador), $this->object->getOperadores(),
            'ERROR: el valor devuelto no es el esperado');
    }
//******************************************************************************
...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: grupoCrear ">
    ...
    public function testGrupoCrear()
    {
        ...
        $this->assertEquals(array($resultado), $this->object->getOperadores(),
...
// <editor-fold defaultstate="collapsed" desc=" Tests para la función: setGrupoAnteriorActual ">
     ...
     */
    public function testSetGrupoAnteriorActual__No_tiene_grupo_padre()
    {
...
//******************************************************************************
     ...
     * @group setGrupoAnteriorActual
     */
    public function testSetGrupoAnteriorActual__Tiene_grupo_padre()
    {
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar_Con_operador()
    {
...
//******************************************************************************
     ...
     * @group generar
     */
    public function testGenerar_Sin_operador()
    {
